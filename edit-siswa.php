 ...
 <form action="simpan-siswa.php" method="POST">
  ...
  <div class="form-group">
      <label>Nama Lengkap</label> 
        <input type="text" name="nama_lengkap" value="<?= $row['nama_lengkap'] ?>" placeholder="Masukkan Nama Siswa" class="form-control">
      </div>
  <div class="form-group">
    <label>Alamat</label>
      <textarea class="form-control" name="alamat" placeholder="Masukkan Alamat Siswa” rows="4"><?= $row['alamat'] ?></textarea>
        </div>
